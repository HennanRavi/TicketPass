      ...
      <div className="sticky top-20">
        <Card className="border-none shadow-2xl">
          ...
          <CardContent className="p-6 space-y-6">
            <div>
              <p className="text-sm text-gray-500 mb-1">Preço por ingresso</p>
            ...
            {availableTickets > 0 ? (
              <>
                <div>
                  <p className="text-sm text-gray-500 mb-3">Quantidade</p>
              ...
              <Alert className="bg-red-50 border-red-200">
                ...
                <AlertDescription className="text-sm text-red-900 font-semibold">
                  Ingressos Esgotados
                </AlertDescription>
              </Alert>
            )}
