      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  <h4 className="font-semibold text-purple-900 mb-3">📝 Como se tornar Organizador:</h4>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">🎯 Menu de Navegação</h4>
                ...
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  <h4 className="font-semibold text-green-900 mb-2">📊 Dashboard do Organizador</h4>
          ...
          <Card className="border-none shadow-xl">
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Escolha uma Imagem Atraente</h3>
                  <p className="text-gray-600 text-sm mb-3">
                    A imagem é o primeiro contato do público com seu evento. Escolha uma imagem de alta qualidade e relevante.
                  </p>
                  <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                    <h4 className="font-semibold text-green-900 mb-2">✨ Validação Automática por IA:</h4>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-blue-900">Título e Descrição</h4>
                  </div>
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  ...
                  <ul className="space-y-1 text-sm text-purple-800 ml-7">
                ...
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-green-900">Data e Hora</h4>
                  </div>
                ...
                <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-orange-900">Categoria e Capacidade</h4>
                  </div>
                  <ul className="space-y-1 text-sm text-orange-800 ml-7">
                ...
                <div className="bg-pink-50 rounded-lg p-4 border border-pink-200">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-semibold text-pink-900">Preço do Ingresso</h4>
                  </div>
                  <ul className="space-y-1 text-sm text-pink-800 ml-7">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Clique em "Criar Evento"</h3>
                    <p className="text-gray-600 text-sm mb-3">
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-4 border-2 border-indigo-200">
                      <h4 className="font-semibold text-indigo-900 mb-2">🎉 O que acontece após publicar:</h4>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <div className="bg-cyan-50 rounded-lg p-3 border border-cyan-200">
                  <h4 className="font-semibold text-cyan-900 text-sm mb-1">📊 Ver Estatísticas</h4>
                  <p className="text-xs text-cyan-800">Vendas, receita, ingressos vendidos</p>
                </div>

                <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                  <h4 className="font-semibold text-blue-900 text-sm mb-1">✏️ Editar Evento</h4>
                  <p className="text-xs text-blue-800">Atualizar informações, datas, preços</p>
                </div>

                <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                  <h4 className="font-semibold text-green-900 text-sm mb-1">💰 Acompanhar Vendas</h4>
                  <p className="text-xs text-green-800">Notificações a cada venda realizada</p>
                </div>

                <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
                  <h4 className="font-semibold text-purple-900 text-sm mb-1">⭐ Ver Avaliações</h4>
                  <p className="text-xs text-purple-800">Feedback dos participantes</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="border-none shadow-xl mt-8">
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">❓ Posso criar quantos eventos quiser?</h3>
              <p className="text-sm text-gray-600">Sim! Não há limite de eventos que você pode criar como organizador.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">💳 Como recebo o dinheiro das vendas?</h3>
              <p className="text-sm text-gray-600">O sistema processa os pagamentos. Entre em contato com o suporte para detalhes sobre repasses financeiros.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">✏️ Posso editar um evento já publicado?</h3>
              <p className="text-sm text-gray-600">Sim! Acesse o Dashboard, encontre o evento e clique em "Editar".</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">🎫 Como valido os ingressos no dia?</h3>
              <p className="text-sm text-gray-600">Use a página "Validar Ingresso" (disponível para organizadores) para escanear os QR Codes na entrada.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">📧 Recebo notificações das vendas?</h3>
              <p className="text-sm text-gray-600">Sim! Você recebe uma notificação no sistema a cada venda, com detalhes do comprador e valor.</p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="mt-8 text-center space-y-4">
          <Link to={createPageUrl("UserSettings")}>
            <Button size="lg" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 mr-3">
          ...
          <p className="text-sm text-gray-500">
            Ainda tem dúvidas? <Link to={createPageUrl("Support")} className="text-indigo-600 hover:text-indigo-700 font-medium">Entre em contato</Link>
          </p>
        </div>
      </div>
    </div>
