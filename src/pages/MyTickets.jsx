...
import { Ticket, Calendar, MapPin, QrCode, CheckCircle2, Clock, AlertCircle } from "lucide-react";
              ...
              {activeTickets.length > 0 ? (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {activeTickets.map((ticket) => (
                    <Card key={ticket.id} className="border-none shadow-xl overflow-hidden dark:bg-gray-800">
                      <CardContent className="p-0">
                        ...
                        <div className="p-6 space-y-4 dark:bg-gray-800">
                          ...
                          <QRCodeDisplay value={ticket.ticket_code} />
