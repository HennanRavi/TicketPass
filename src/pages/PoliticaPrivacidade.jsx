    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="border-none shadow-lg mb-6 dark:bg-gray-800">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-lg dark:text-white">
              <Database className="w-5 h-5 text-blue-600 dark:text-purple-400" />
              Informações que Coletamos
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">1. Informações Pessoais</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">2. Informações Automáticas</h3>
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={idx} className="text-sm text-gray-700 dark:text-gray-300 flex items-start gap-2">
                  <span className="w-1 h-1 bg-blue-600 dark:bg-purple-400 rounded-full mt-1.5 flex-shrink-0"></span>
                  {item}
                </li>
              ))}
            </ul>
        ...
        <Card className="border-none shadow-lg mb-6 dark:bg-gray-800">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-lg dark:text-white">
              <UserCheck className="w-5 h-5 text-blue-600 dark:text-purple-400" />
        ...
        <Card className="border-none shadow-lg mb-6 dark:bg-gray-800">
          <CardHeader>
            <CardTitle className="text-lg dark:text-white">Seus Direitos (LGPD)</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
