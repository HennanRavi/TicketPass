              ...
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{existingRefund.event_title}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Valor do Reembolso</p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{existingRefund.reason}</p>
                  </div>
                  ...
                  {existingRefund.status === "rejeitado" && existingRefund.rejection_reason && (
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200 mt-4">
                      <p className="text-sm text-red-600 font-medium mb-1">Motivo da Rejeição</p>
                      <p className="text-sm text-red-800">{existingRefund.rejection_reason}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <div className="min-h-screen py-8 bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="border-none shadow-xl">
            <CardContent className="p-8 text-center">
              <XCircle className="w-16 h-16 text-red-500 mx-auto mb-4" />
              <h2 className="text-xl font-bold text-gray-900 mb-2">Prazo Expirado</h2>
  ...
  return (
    <div className="min-h-screen py-8 bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Solicitar Reembolso</h1>
          <p className="text-gray-600">Preencha o formulário para solicitar o reembolso do seu ingresso</p>
        </div>

        {/* Ticket Info */}
        <Card className="mb-6 border-none shadow-lg">
          <CardContent className="p-6">
            <h3 className="font-semibold text-gray-900 mb-4">Informações do Ingresso</h3>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-600">Evento</span>
                <span className="font-semibold text-gray-900">{ticket.event_title}</span>
              </div>
              <div className="flex justify-between">
